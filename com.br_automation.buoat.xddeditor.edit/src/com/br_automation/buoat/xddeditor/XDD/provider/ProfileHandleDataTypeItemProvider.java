 ...
 * @generated
 */
public class ProfileHandleDataTypeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
    ...
    protected void addProfileIdentificationPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description",
                        "_UI_ProfileHandleDataType_profileIdentification_feature", "_UI_ProfileHandleDataType_type"),
                XDDPackage.eINSTANCE.getProfileHandleDataType_ProfileIdentification(), true, false, false,
    ...
    protected void addProfileRevisionPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ProfileHandleDataType_profileRevision_feature"),
                        getString("_UI_PropertyDescriptor_description",
                                "_UI_ProfileHandleDataType_profileRevision_feature", "_UI_ProfileHandleDataType_type"),
                        XDDPackage.eINSTANCE.getProfileHandleDataType_ProfileRevision(), true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addProfileLocationPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ProfileHandleDataType_profileLocation_feature"),
                        getString("_UI_PropertyDescriptor_description",
                                "_UI_ProfileHandleDataType_profileLocation_feature", "_UI_ProfileHandleDataType_type"),
                        XDDPackage.eINSTANCE.getProfileHandleDataType_ProfileLocation(), true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
