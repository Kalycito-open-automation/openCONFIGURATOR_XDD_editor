 ...
 * @generated
 */
public class FunctionTypeTypeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
    ...
    protected void addNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_FunctionTypeType_name_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_FunctionTypeType_name_feature",
                                "_UI_FunctionTypeType_type"),
                        XDDPackage.eINSTANCE.getFunctionTypeType_Name(), true, false, false,
    ...
    protected void addPackagePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_FunctionTypeType_package_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_FunctionTypeType_package_feature",
                                "_UI_FunctionTypeType_type"),
                        XDDPackage.eINSTANCE.getFunctionTypeType_Package(), true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addUniqueIDPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_FunctionTypeType_uniqueID_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_FunctionTypeType_uniqueID_feature",
                                "_UI_FunctionTypeType_type"),
                        XDDPackage.eINSTANCE.getFunctionTypeType_UniqueID(), true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors
                .add(createChildParameter(XDDPackage.eINSTANCE.getFunctionTypeType_Group(), FeatureMapUtil.createEntry(
                        XDDPackage.eINSTANCE.getFunctionTypeType_Label(), XDDFactory.eINSTANCE.createLabelType())));

        newChildDescriptors.add(createChildParameter(XDDPackage.eINSTANCE.getFunctionTypeType_Group(),
                FeatureMapUtil.createEntry(XDDPackage.eINSTANCE.getFunctionTypeType_Description(),
                        XDDFactory.eINSTANCE.createDescriptionType())));

        newChildDescriptors.add(createChildParameter(XDDPackage.eINSTANCE.getFunctionTypeType_Group(),
                FeatureMapUtil.createEntry(XDDPackage.eINSTANCE.getFunctionTypeType_LabelRef(),
                        XDDFactory.eINSTANCE.createLabelRefType())));

        newChildDescriptors.add(createChildParameter(XDDPackage.eINSTANCE.getFunctionTypeType_Group(),
                FeatureMapUtil.createEntry(XDDPackage.eINSTANCE.getFunctionTypeType_DescriptionRef(),
                        XDDFactory.eINSTANCE.createDescriptionRefType())));

        newChildDescriptors.add(createChildParameter(XDDPackage.eINSTANCE.getFunctionTypeType_VersionInfo(),
                XDDFactory.eINSTANCE.createVersionInfoType()));

        newChildDescriptors.add(createChildParameter(XDDPackage.eINSTANCE.getFunctionTypeType_InterfaceList(),
                XDDFactory.eINSTANCE.createInterfaceListType()));

        newChildDescriptors.add(createChildParameter(XDDPackage.eINSTANCE.getFunctionTypeType_FunctionInstanceList(),
