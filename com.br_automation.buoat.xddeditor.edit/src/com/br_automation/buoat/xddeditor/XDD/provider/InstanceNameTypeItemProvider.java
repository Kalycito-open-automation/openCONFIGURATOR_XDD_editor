 ...
 * @generated
 */
public class InstanceNameTypeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
    ...
    protected void addValuePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_InstanceNameType_value_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_InstanceNameType_value_feature",
                                "_UI_InstanceNameType_type"),
                        XDDPackage.eINSTANCE.getInstanceNameType_Value(), true, false, false,
    ...
    protected void addReadOnlyPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_InstanceNameType_readOnly_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_InstanceNameType_readOnly_feature",
                                "_UI_InstanceNameType_type"),
                        XDDPackage.eINSTANCE.getInstanceNameType_ReadOnly(), true, false, false,
