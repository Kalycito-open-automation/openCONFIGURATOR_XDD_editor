 ...
 * @generated
 */
public class FunctionInstanceTypeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
    ...
    protected void addNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_FunctionInstanceType_name_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_FunctionInstanceType_name_feature",
                                "_UI_FunctionInstanceType_type"),
                        XDDPackage.eINSTANCE.getFunctionInstanceType_Name(), true, false, false,
    ...
    protected void addTypeIDRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_FunctionInstanceType_typeIDRef_feature",
                        "_UI_FunctionInstanceType_type"),
                XDDPackage.eINSTANCE.getFunctionInstanceType_TypeIDRef(), true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addUniqueIDPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_FunctionInstanceType_uniqueID_feature",
                        "_UI_FunctionInstanceType_type"),
                XDDPackage.eINSTANCE.getFunctionInstanceType_UniqueID(), true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(
                createChildParameter(XDDPackage.eINSTANCE.getFunctionInstanceType_Group(), FeatureMapUtil.createEntry(
                        XDDPackage.eINSTANCE.getFunctionInstanceType_Label(), XDDFactory.eINSTANCE.createLabelType())));

        newChildDescriptors.add(createChildParameter(XDDPackage.eINSTANCE.getFunctionInstanceType_Group(),
                FeatureMapUtil.createEntry(XDDPackage.eINSTANCE.getFunctionInstanceType_Description(),
                        XDDFactory.eINSTANCE.createDescriptionType())));

        newChildDescriptors.add(createChildParameter(XDDPackage.eINSTANCE.getFunctionInstanceType_Group(),
                FeatureMapUtil.createEntry(XDDPackage.eINSTANCE.getFunctionInstanceType_LabelRef(),
                        XDDFactory.eINSTANCE.createLabelRefType())));

        newChildDescriptors.add(createChildParameter(XDDPackage.eINSTANCE.getFunctionInstanceType_Group(),
                FeatureMapUtil.createEntry(XDDPackage.eINSTANCE.getFunctionInstanceType_DescriptionRef(),
