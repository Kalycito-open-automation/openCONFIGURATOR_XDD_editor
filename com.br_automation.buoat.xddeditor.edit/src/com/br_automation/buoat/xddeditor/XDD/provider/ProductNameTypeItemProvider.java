 ...
 * @generated
 */
public class ProductNameTypeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
    ...
    protected void addValuePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ProductNameType_value_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_ProductNameType_value_feature",
                                "_UI_ProductNameType_type"),
                        XDDPackage.eINSTANCE.getProductNameType_Value(), true, false, false,
    ...
    protected void addReadOnlyPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ProductNameType_readOnly_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_ProductNameType_readOnly_feature",
                                "_UI_ProductNameType_type"),
                        XDDPackage.eINSTANCE.getProductNameType_ReadOnly(), true, false, false,
