...
public class DocumentRootItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
    ...
    protected void addClassificationPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_DocumentRoot_classification_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_DocumentRoot_classification_feature",
                                "_UI_DocumentRoot_type"),
                        XDDPackage.eINSTANCE.getDocumentRoot_Classification(), true, false, false,
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(XDDPackage.eINSTANCE.getDocumentRoot_Connector(),
                XDDFactory.eINSTANCE.createConnectorType()));

        newChildDescriptors.add(createChildParameter(XDDPackage.eINSTANCE.getDocumentRoot_Firmware(),
                XDDFactory.eINSTANCE.createFirmwareType()));

        newChildDescriptors.add(createChildParameter(XDDPackage.eINSTANCE.getDocumentRoot_ISO15745Profile(),
                XDDFactory.eINSTANCE.createISO15745ProfileType()));

        newChildDescriptors.add(createChildParameter(XDDPackage.eINSTANCE.getDocumentRoot_ISO15745ProfileContainer(),
                XDDFactory.eINSTANCE.createISO15745ProfileContainerType()));

        newChildDescriptors.add(createChildParameter(XDDPackage.eINSTANCE.getDocumentRoot_TextResource(),
