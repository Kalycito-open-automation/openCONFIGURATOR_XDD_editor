 ...
 * @generated
 */
public class ObjectListTypeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
    ...
    protected void addMandatoryObjectsPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ObjectListType_mandatoryObjects_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_ObjectListType_mandatoryObjects_feature",
                                "_UI_ObjectListType_type"),
    ...
    protected void addManufacturerObjectsPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_ObjectListType_manufacturerObjects_feature",
                        "_UI_ObjectListType_type"),
    ...
    protected void addOptionalObjectsPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ObjectListType_optionalObjects_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_ObjectListType_optionalObjects_feature",
                                "_UI_ObjectListType_type"),
                        XDDPackage.eINSTANCE.getObjectListType_OptionalObjects(), true, false, false,
                        ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
    }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(XDDPackage.eINSTANCE.getObjectListType_Object(),
