 ...
 * @generated
 */
public class TDeviceCommissioningItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
    ...
    protected void addNetworkNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_TDeviceCommissioning_networkName_feature",
                        "_UI_TDeviceCommissioning_type"),
    ...
    protected void addNodeIDPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_TDeviceCommissioning_nodeID_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_TDeviceCommissioning_nodeID_feature",
                                "_UI_TDeviceCommissioning_type"),
                        XDDPackage.eINSTANCE.getTDeviceCommissioning_NodeID(), true, false, false,
    ...
    protected void addNodeNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_TDeviceCommissioning_nodeName_feature",
                        "_UI_TDeviceCommissioning_type"),
                XDDPackage.eINSTANCE.getTDeviceCommissioning_NodeName(), true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addNodeTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_TDeviceCommissioning_nodeType_feature",
                        "_UI_TDeviceCommissioning_type"),
                XDDPackage.eINSTANCE.getTDeviceCommissioning_NodeType(), true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addUsedNetworkInterfacePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_TDeviceCommissioning_usedNetworkInterface_feature",
                        "_UI_TDeviceCommissioning_type"),
                XDDPackage.eINSTANCE.getTDeviceCommissioning_UsedNetworkInterface(), true, false, false,
                ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
    }
