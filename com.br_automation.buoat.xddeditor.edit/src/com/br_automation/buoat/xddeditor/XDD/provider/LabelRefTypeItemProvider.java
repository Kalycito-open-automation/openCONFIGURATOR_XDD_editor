 ...
 * @generated
 */
public class LabelRefTypeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
    ...
    protected void addValuePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_LabelRefType_value_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_LabelRefType_value_feature",
                                "_UI_LabelRefType_type"),
                        XDDPackage.eINSTANCE.getLabelRefType_Value(), true, false, false,
    ...
    protected void addDictIDPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_LabelRefType_dictID_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_LabelRefType_dictID_feature",
                                "_UI_LabelRefType_type"),
                        XDDPackage.eINSTANCE.getLabelRefType_DictID(), true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addTextIDPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_LabelRefType_textID_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_LabelRefType_textID_feature",
                                "_UI_LabelRefType_type"),
                        XDDPackage.eINSTANCE.getLabelRefType_TextID(), true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
