 ...
 * @generated
 */
public class InstanceIDRefTypeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
    ...
    protected void addUniqueIDRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_InstanceIDRefType_uniqueIDRef_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_InstanceIDRefType_uniqueIDRef_feature",
                                "_UI_InstanceIDRefType_type"),
                        XDDPackage.eINSTANCE.getInstanceIDRefType_UniqueIDRef(), true, false, false,
