...
public class TLEDItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
    ...
    protected void addLEDcolorsPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_TLED_lEDcolors_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_TLED_lEDcolors_feature", "_UI_TLED_type"),
                        XDDPackage.eINSTANCE.getTLED_LEDcolors(), true, false, false,
    ...
    protected void addLEDtypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_TLED_lEDtype_feature"),
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(XDDPackage.eINSTANCE.getTLED_Group(), FeatureMapUtil
                .createEntry(XDDPackage.eINSTANCE.getTLED_Label(), XDDFactory.eINSTANCE.createLabelType())));

        newChildDescriptors.add(createChildParameter(XDDPackage.eINSTANCE.getTLED_Group(), FeatureMapUtil.createEntry(
                XDDPackage.eINSTANCE.getTLED_Description(), XDDFactory.eINSTANCE.createDescriptionType())));

        newChildDescriptors.add(createChildParameter(XDDPackage.eINSTANCE.getTLED_Group(), FeatureMapUtil
                .createEntry(XDDPackage.eINSTANCE.getTLED_LabelRef(), XDDFactory.eINSTANCE.createLabelRefType())));

        newChildDescriptors.add(createChildParameter(XDDPackage.eINSTANCE.getTLED_Group(), FeatureMapUtil.createEntry(
                XDDPackage.eINSTANCE.getTLED_DescriptionRef(), XDDFactory.eINSTANCE.createDescriptionRefType())));

        newChildDescriptors.add(createChildParameter(XDDPackage.eINSTANCE.getTLED_LEDstate(),
