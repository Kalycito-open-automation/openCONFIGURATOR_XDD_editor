...
public class ProfileBodyDevicePowerlinkItemProvider extends ProfileBodyDataTypeItemProvider {
    ...
    protected void addDeviceClassPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_ProfileBodyDevicePowerlink_deviceClass_feature",
                        "_UI_ProfileBodyDevicePowerlink_type"),
                XDDPackage.eINSTANCE.getProfileBodyDevicePowerlink_DeviceClass(), true, false, false,
    ...
    protected void addSpecificationVersionPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ProfileBodyDevicePowerlink_specificationVersion_feature"),
                        getString("_UI_PropertyDescriptor_description",
                                "_UI_ProfileBodyDevicePowerlink_specificationVersion_feature",
                                "_UI_ProfileBodyDevicePowerlink_type"),
                        XDDPackage.eINSTANCE.getProfileBodyDevicePowerlink_SpecificationVersion(), true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors
                .add(createChildParameter(XDDPackage.eINSTANCE.getProfileBodyDevicePowerlink_DeviceIdentity(),
                        XDDFactory.eINSTANCE.createTDeviceIdentity()));

        newChildDescriptors.add(createChildParameter(XDDPackage.eINSTANCE.getProfileBodyDevicePowerlink_DeviceManager(),
                XDDFactory.eINSTANCE.createTDeviceManager()));

        newChildDescriptors
                .add(createChildParameter(XDDPackage.eINSTANCE.getProfileBodyDevicePowerlink_DeviceFunction(),
                        XDDFactory.eINSTANCE.createTDeviceFunction()));

        newChildDescriptors
                .add(createChildParameter(XDDPackage.eINSTANCE.getProfileBodyDevicePowerlink_ApplicationProcess(),
                        XDDFactory.eINSTANCE.createTApplicationProcess()));

        newChildDescriptors
                .add(createChildParameter(XDDPackage.eINSTANCE.getProfileBodyDevicePowerlink_ExternalProfileHandle(),
