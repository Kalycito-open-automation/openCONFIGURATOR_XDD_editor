 ...
 * @generated
 */
public class TSubrangeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
    ...
    protected void addLowerLimitPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_TSubrange_lowerLimit_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_TSubrange_lowerLimit_feature",
                                "_UI_TSubrange_type"),
                        XDDPackage.eINSTANCE.getTSubrange_LowerLimit(), true, false, false,
    ...
    protected void addUpperLimitPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_TSubrange_upperLimit_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_TSubrange_upperLimit_feature",
                                "_UI_TSubrange_type"),
                        XDDPackage.eINSTANCE.getTSubrange_UpperLimit(), true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_TSubrange_type")
