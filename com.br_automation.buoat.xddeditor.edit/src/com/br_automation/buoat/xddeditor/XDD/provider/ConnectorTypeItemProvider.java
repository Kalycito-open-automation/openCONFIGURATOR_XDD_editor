 ...
 * {@link com.br_automation.buoat.xddeditor.XDD.ConnectorType} object. <!--
...
public class ConnectorTypeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
    ...
    protected void addConnectorTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ConnectorType_connectorType_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_ConnectorType_connectorType_feature",
                                "_UI_ConnectorType_type"),
                        XDDPackage.eINSTANCE.getConnectorType_ConnectorType(), true, false, false,
        ...
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_ConnectorType_id_feature",
                                "_UI_ConnectorType_type"),
                        XDDPackage.eINSTANCE.getConnectorType_Id(), true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addPositioningPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ConnectorType_positioning_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_ConnectorType_positioning_feature",
                                "_UI_ConnectorType_type"),
                        XDDPackage.eINSTANCE.getConnectorType_Positioning(), true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addPosXPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ConnectorType_posX_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_ConnectorType_posX_feature",
                                "_UI_ConnectorType_type"),
                        XDDPackage.eINSTANCE.getConnectorType_PosX(), true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addPosYPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ConnectorType_posY_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_ConnectorType_posY_feature",
                                "_UI_ConnectorType_type"),
                        XDDPackage.eINSTANCE.getConnectorType_PosY(), true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    /**
     * This returns ConnectorType.gif. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
     * @generated
     */
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(XDDPackage.eINSTANCE.getConnectorType_Group(), FeatureMapUtil
                .createEntry(XDDPackage.eINSTANCE.getConnectorType_Label(), XDDFactory.eINSTANCE.createLabelType())));

        newChildDescriptors.add(createChildParameter(XDDPackage.eINSTANCE.getConnectorType_Group(),
                FeatureMapUtil.createEntry(XDDPackage.eINSTANCE.getConnectorType_Description(),
                        XDDFactory.eINSTANCE.createDescriptionType())));

        newChildDescriptors
                .add(createChildParameter(XDDPackage.eINSTANCE.getConnectorType_Group(), FeatureMapUtil.createEntry(
                        XDDPackage.eINSTANCE.getConnectorType_LabelRef(), XDDFactory.eINSTANCE.createLabelRefType())));

        newChildDescriptors.add(createChildParameter(XDDPackage.eINSTANCE.getConnectorType_Group(),
                FeatureMapUtil.createEntry(XDDPackage.eINSTANCE.getConnectorType_DescriptionRef(),
