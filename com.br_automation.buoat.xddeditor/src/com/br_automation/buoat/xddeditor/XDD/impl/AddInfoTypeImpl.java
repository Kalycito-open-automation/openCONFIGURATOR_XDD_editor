 ...
 * </p>
 * <ul>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.AddInfoTypeImpl#getGroup
 * <em>Group</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.AddInfoTypeImpl#getLabel
 * <em>Label</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.AddInfoTypeImpl#getDescription
 * <em>Description</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.AddInfoTypeImpl#getLabelRef
 * <em>Label Ref</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.AddInfoTypeImpl#getDescriptionRef
 * <em>Description Ref</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.AddInfoTypeImpl#getValue
 * <em>Value</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.AddInfoTypeImpl#getBitOffset
 * <em>Bit Offset</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.AddInfoTypeImpl#getLen
 * <em>Len</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.AddInfoTypeImpl#getName
 * <em>Name</em>}</li>
 * </ul>
 *
 * @generated
...
public class AddInfoTypeImpl extends EObjectImpl implements AddInfoType {
    ...
    public void setBitOffset(short newBitOffset) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.ADD_INFO_TYPE__BIT_OFFSET, oldBitOffset,
    ...
    public void unsetBitOffset() {
        ...
        bitOffsetESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.ADD_INFO_TYPE__BIT_OFFSET, oldBitOffset,
                    BIT_OFFSET_EDEFAULT, oldBitOffsetESet));
    }
    ...
    public void setLen(short newLen) {
        ...
        lenESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.ADD_INFO_TYPE__LEN, oldLen, len,
                    !oldLenESet));
    }
    ...
    public void unsetLen() {
        ...
        lenESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.ADD_INFO_TYPE__LEN, oldLen, LEN_EDEFAULT,
                    oldLenESet));
    }
