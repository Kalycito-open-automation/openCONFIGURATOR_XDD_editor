 ...
 * </p>
 * <ul>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TSubrangeImpl#getLowerLimit
 * <em>Lower Limit</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TSubrangeImpl#getUpperLimit
...
public class TSubrangeImpl extends EObjectImpl implements TSubrange {
    ...
    public void setLowerLimit(BigInteger newLowerLimit) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TSUBRANGE__LOWER_LIMIT, oldLowerLimit,
                    lowerLimit));
    }
    ...
    public void setUpperLimit(BigInteger newUpperLimit) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TSUBRANGE__UPPER_LIMIT, oldUpperLimit,
                    upperLimit));
    }
