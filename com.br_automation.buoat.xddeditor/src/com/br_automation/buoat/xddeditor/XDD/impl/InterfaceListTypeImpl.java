 ...
 * </p>
 * <ul>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.InterfaceListTypeImpl#getInputVars
 * <em>Input Vars</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.InterfaceListTypeImpl#getOutputVars
 * <em>Output Vars</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.InterfaceListTypeImpl#getConfigVars
...
public class InterfaceListTypeImpl extends EObjectImpl implements InterfaceListType {
    ...
    public void setInputVars(InputVarsType newInputVars) {
        if (newInputVars != inputVars) {
            ...
            if (inputVars != null)
                msgs = ((InternalEObject) inputVars).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - XDDPackage.INTERFACE_LIST_TYPE__INPUT_VARS, null, msgs);
            if (newInputVars != null)
                msgs = ((InternalEObject) newInputVars).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - XDDPackage.INTERFACE_LIST_TYPE__INPUT_VARS, null, msgs);
            msgs = basicSetInputVars(newInputVars, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.INTERFACE_LIST_TYPE__INPUT_VARS,
                    newInputVars, newInputVars));
    }
    ...
    public void setOutputVars(OutputVarsType newOutputVars) {
        if (newOutputVars != outputVars) {
            NotificationChain msgs = null;
            if (outputVars != null)
                msgs = ((InternalEObject) outputVars).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - XDDPackage.INTERFACE_LIST_TYPE__OUTPUT_VARS, null, msgs);
            if (newOutputVars != null)
                msgs = ((InternalEObject) newOutputVars).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - XDDPackage.INTERFACE_LIST_TYPE__OUTPUT_VARS, null, msgs);
            msgs = basicSetOutputVars(newOutputVars, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.INTERFACE_LIST_TYPE__OUTPUT_VARS,
                    newOutputVars, newOutputVars));
    }
    ...
    public void setConfigVars(ConfigVarsType newConfigVars) {
        if (newConfigVars != configVars) {
            NotificationChain msgs = null;
            if (configVars != null)
                msgs = ((InternalEObject) configVars).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - XDDPackage.INTERFACE_LIST_TYPE__CONFIG_VARS, null, msgs);
            if (newConfigVars != null)
                msgs = ((InternalEObject) newConfigVars).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - XDDPackage.INTERFACE_LIST_TYPE__CONFIG_VARS, null, msgs);
            msgs = basicSetConfigVars(newConfigVars, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.INTERFACE_LIST_TYPE__CONFIG_VARS,
                    newConfigVars, newConfigVars));
    }
