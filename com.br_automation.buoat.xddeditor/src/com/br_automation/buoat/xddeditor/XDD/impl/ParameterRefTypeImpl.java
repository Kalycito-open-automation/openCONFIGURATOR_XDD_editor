 ...
 * </p>
 * <ul>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ParameterRefTypeImpl#getActualValue
 * <em>Actual Value</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ParameterRefTypeImpl#getBitOffset
 * <em>Bit Offset</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ParameterRefTypeImpl#isLocked
 * <em>Locked</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ParameterRefTypeImpl#getUniqueIDRef
 * <em>Unique ID Ref</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ParameterRefTypeImpl#isVisible
 * <em>Visible</em>}</li>
 * </ul>
 *
 * @generated
...
public class ParameterRefTypeImpl extends EObjectImpl implements ParameterRefType {
    ...
    /**
     * This is true if the Locked attribute has been set. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     *
     * @generated
     * @ordered
    ...
    public void setActualValue(String newActualValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.PARAMETER_REF_TYPE__ACTUAL_VALUE,
    ...
    public void setBitOffset(BigInteger newBitOffset) {
        ...
        bitOffsetESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.PARAMETER_REF_TYPE__BIT_OFFSET,
                    oldBitOffset, bitOffset, !oldBitOffsetESet));
    }
    ...
    public void unsetBitOffset() {
        ...
        bitOffsetESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.PARAMETER_REF_TYPE__BIT_OFFSET,
    ...
    public void setLocked(boolean newLocked) {
        ...
        lockedESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.PARAMETER_REF_TYPE__LOCKED, oldLocked,
                    locked, !oldLockedESet));
    }
    ...
    public void unsetLocked() {
        ...
        lockedESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.PARAMETER_REF_TYPE__LOCKED, oldLocked,
    ...
    public void setUniqueIDRef(String newUniqueIDRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.PARAMETER_REF_TYPE__UNIQUE_ID_REF,
    ...
    public void setVisible(boolean newVisible) {
        ...
        visibleESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.PARAMETER_REF_TYPE__VISIBLE, oldVisible,
    ...
    public void unsetVisible() {
        ...
        visibleESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.PARAMETER_REF_TYPE__VISIBLE, oldVisible,
