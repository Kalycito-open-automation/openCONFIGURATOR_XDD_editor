 ...
 * </p>
 * <ul>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TFunctionTypeListImpl#getFunctionType
...
public class TFunctionTypeListImpl extends EObjectImpl implements TFunctionTypeList {
    /**
     * The cached value of the '{@link #getFunctionType() <em>Function
     * Type</em>}' containment reference list. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @see #getFunctionType()
     * @generated
    ...
    public EList<FunctionTypeType> getFunctionType() {
        if (functionType == null) {
            functionType = new EObjectContainmentEList<FunctionTypeType>(FunctionTypeType.class, this,
                    XDDPackage.TFUNCTION_TYPE_LIST__FUNCTION_TYPE);
        }
        return functionType;
    }
