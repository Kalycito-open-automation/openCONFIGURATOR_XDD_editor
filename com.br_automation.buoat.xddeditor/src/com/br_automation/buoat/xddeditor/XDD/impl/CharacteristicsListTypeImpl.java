 ...
 * </p>
 * <ul>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.CharacteristicsListTypeImpl#getCategory
 * <em>Category</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.CharacteristicsListTypeImpl#getCharacteristic
...
public class CharacteristicsListTypeImpl extends EObjectImpl implements CharacteristicsListType {
        ...
        if (newCategory != category) {
            ...
            if (category != null)
                msgs = ((InternalEObject) category).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - XDDPackage.CHARACTERISTICS_LIST_TYPE__CATEGORY, null, msgs);
            if (newCategory != null)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.CHARACTERISTICS_LIST_TYPE__CATEGORY,
    ...
    public EList<CharacteristicType> getCharacteristic() {
        if (characteristic == null) {
            characteristic = new EObjectContainmentEList<CharacteristicType>(CharacteristicType.class, this,
