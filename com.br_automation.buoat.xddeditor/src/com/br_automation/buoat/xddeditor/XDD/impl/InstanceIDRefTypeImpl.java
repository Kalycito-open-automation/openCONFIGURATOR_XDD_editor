 ...
 * </p>
 * <ul>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.InstanceIDRefTypeImpl#getUniqueIDRef
...
public class InstanceIDRefTypeImpl extends EObjectImpl implements InstanceIDRefType {
    ...
    public void setUniqueIDRef(String newUniqueIDRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.INSTANCE_ID_REF_TYPE__UNIQUE_ID_REF,
