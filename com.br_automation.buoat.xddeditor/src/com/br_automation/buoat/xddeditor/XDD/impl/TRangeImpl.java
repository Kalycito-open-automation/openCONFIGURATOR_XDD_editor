 ...
 * <em>Max Value</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TRangeImpl#getStep
 * <em>Step</em>}</li>
 * </ul>
 *
 * @generated
...
public class TRangeImpl extends EObjectImpl implements TRange {
    ...
    public NotificationChain basicSetMinValue(MinValueType newMinValue, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XDDPackage.TRANGE__MIN_VALUE,
    ...
    public void setMinValue(MinValueType newMinValue) {
        if (newMinValue != minValue) {
            ...
            if (minValue != null)
                msgs = ((InternalEObject) minValue).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - XDDPackage.TRANGE__MIN_VALUE, null, msgs);
            if (newMinValue != null)
                msgs = ((InternalEObject) newMinValue).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - XDDPackage.TRANGE__MIN_VALUE, null, msgs);
            msgs = basicSetMinValue(newMinValue, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TRANGE__MIN_VALUE, newMinValue,
                    newMinValue));
    }
    ...
    public NotificationChain basicSetMaxValue(MaxValueType newMaxValue, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XDDPackage.TRANGE__MAX_VALUE,
    ...
    public void setMaxValue(MaxValueType newMaxValue) {
        if (newMaxValue != maxValue) {
            NotificationChain msgs = null;
            if (maxValue != null)
                msgs = ((InternalEObject) maxValue).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - XDDPackage.TRANGE__MAX_VALUE, null, msgs);
            if (newMaxValue != null)
                msgs = ((InternalEObject) newMaxValue).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - XDDPackage.TRANGE__MAX_VALUE, null, msgs);
            msgs = basicSetMaxValue(newMaxValue, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TRANGE__MAX_VALUE, newMaxValue,
                    newMaxValue));
    }
    ...
    public NotificationChain basicSetStep(StepType newStep, NotificationChain msgs) {
        ...
        step = newStep;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XDDPackage.TRANGE__STEP,
                    oldStep, newStep);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setStep(StepType newStep) {
        if (newStep != step) {
            NotificationChain msgs = null;
            if (step != null)
                msgs = ((InternalEObject) step).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XDDPackage.TRANGE__STEP,
                        null, msgs);
            if (newStep != null)
                msgs = ((InternalEObject) newStep).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XDDPackage.TRANGE__STEP,
                        null, msgs);
