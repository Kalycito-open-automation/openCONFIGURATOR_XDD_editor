 ...
 * Body Communication Network Powerlink</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ProfileBodyCommunicationNetworkPowerlinkImpl#getApplicationLayers
 * <em>Application Layers</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ProfileBodyCommunicationNetworkPowerlinkImpl#getTransportLayers
 * <em>Transport Layers</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ProfileBodyCommunicationNetworkPowerlinkImpl#getNetworkManagement
 * <em>Network Management</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ProfileBodyCommunicationNetworkPowerlinkImpl#getExternalProfileHandle
 * <em>External Profile Handle</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ProfileBodyCommunicationNetworkPowerlinkImpl#getSpecificationVersion
 * <em>Specification Version</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProfileBodyCommunicationNetworkPowerlinkImpl extends ProfileBodyDataTypeImpl
        implements ProfileBodyCommunicationNetworkPowerlink {
    /**
     * The cached value of the '{@link #getApplicationLayers() <em>Application
     * Layers</em>}' containment reference. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getTransportLayers() <em>Transport
     * Layers</em>}' containment reference. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getNetworkManagement() <em>Network
    ...
    public NotificationChain basicSetApplicationLayers(TApplicationLayers newApplicationLayers,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    XDDPackage.PROFILE_BODY_COMMUNICATION_NETWORK_POWERLINK__APPLICATION_LAYERS, oldApplicationLayers,
                    newApplicationLayers);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setApplicationLayers(TApplicationLayers newApplicationLayers) {
        if (newApplicationLayers != applicationLayers) {
            ...
            if (applicationLayers != null)
                msgs = ((InternalEObject) applicationLayers).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE
                                - XDDPackage.PROFILE_BODY_COMMUNICATION_NETWORK_POWERLINK__APPLICATION_LAYERS,
                        null, msgs);
            if (newApplicationLayers != null)
                msgs = ((InternalEObject) newApplicationLayers).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE
                                - XDDPackage.PROFILE_BODY_COMMUNICATION_NETWORK_POWERLINK__APPLICATION_LAYERS,
                        null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    XDDPackage.PROFILE_BODY_COMMUNICATION_NETWORK_POWERLINK__APPLICATION_LAYERS, newApplicationLayers,
                    newApplicationLayers));
    }
    ...
    public NotificationChain basicSetTransportLayers(EObject newTransportLayers, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    XDDPackage.PROFILE_BODY_COMMUNICATION_NETWORK_POWERLINK__TRANSPORT_LAYERS, oldTransportLayers,
                    newTransportLayers);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setTransportLayers(EObject newTransportLayers) {
        if (newTransportLayers != transportLayers) {
            ...
            if (transportLayers != null)
                msgs = ((InternalEObject) transportLayers).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE
                                - XDDPackage.PROFILE_BODY_COMMUNICATION_NETWORK_POWERLINK__TRANSPORT_LAYERS,
                        null, msgs);
            if (newTransportLayers != null)
                msgs = ((InternalEObject) newTransportLayers).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE
                                - XDDPackage.PROFILE_BODY_COMMUNICATION_NETWORK_POWERLINK__TRANSPORT_LAYERS,
                        null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    XDDPackage.PROFILE_BODY_COMMUNICATION_NETWORK_POWERLINK__TRANSPORT_LAYERS, newTransportLayers,
                    newTransportLayers));
    }
    ...
    public NotificationChain basicSetNetworkManagement(TNetworkManagement newNetworkManagement,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    XDDPackage.PROFILE_BODY_COMMUNICATION_NETWORK_POWERLINK__NETWORK_MANAGEMENT, oldNetworkManagement,
                    newNetworkManagement);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setNetworkManagement(TNetworkManagement newNetworkManagement) {
        if (newNetworkManagement != networkManagement) {
            ...
            if (networkManagement != null)
                msgs = ((InternalEObject) networkManagement).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE
                                - XDDPackage.PROFILE_BODY_COMMUNICATION_NETWORK_POWERLINK__NETWORK_MANAGEMENT,
                        null, msgs);
            if (newNetworkManagement != null)
                msgs = ((InternalEObject) newNetworkManagement).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE
                                - XDDPackage.PROFILE_BODY_COMMUNICATION_NETWORK_POWERLINK__NETWORK_MANAGEMENT,
                        null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    XDDPackage.PROFILE_BODY_COMMUNICATION_NETWORK_POWERLINK__NETWORK_MANAGEMENT, newNetworkManagement,
                    newNetworkManagement));
    }
    ...
    public EList<ProfileHandleDataType> getExternalProfileHandle() {
        if (externalProfileHandle == null) {
            externalProfileHandle = new EObjectContainmentEList<ProfileHandleDataType>(ProfileHandleDataType.class,
                    this, XDDPackage.PROFILE_BODY_COMMUNICATION_NETWORK_POWERLINK__EXTERNAL_PROFILE_HANDLE);
        }
    ...
    public void setSpecificationVersion(TSpecificationVersion newSpecificationVersion) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    XDDPackage.PROFILE_BODY_COMMUNICATION_NETWORK_POWERLINK__SPECIFICATION_VERSION,
                    oldSpecificationVersion, specificationVersion, !oldSpecificationVersionESet));
    }
    ...
    public void unsetSpecificationVersion() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET,
                    XDDPackage.PROFILE_BODY_COMMUNICATION_NETWORK_POWERLINK__SPECIFICATION_VERSION,
                    oldSpecificationVersion, SPECIFICATION_VERSION_EDEFAULT, oldSpecificationVersionESet));
    }
