 ...
 * </p>
 * <ul>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ISO15745ProfileContainerTypeImpl#getISO15745Profile
...
public class ISO15745ProfileContainerTypeImpl extends EObjectImpl implements ISO15745ProfileContainerType {
    /**
     * The cached value of the '{@link #getISO15745Profile() <em>ISO15745
     * Profile</em>}' containment reference list. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    public EList<ISO15745ProfileType> getISO15745Profile() {
        if (iSO15745Profile == null) {
            iSO15745Profile = new EObjectContainmentEList<ISO15745ProfileType>(ISO15745ProfileType.class, this,
