 ...
 * </p>
 * <ul>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.VendorNameTypeImpl#getValue
 * <em>Value</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.VendorNameTypeImpl#isReadOnly
 * <em>Read Only</em>}</li>
 * </ul>
 *
 * @generated
...
public class VendorNameTypeImpl extends EObjectImpl implements VendorNameType {
    ...
    public void setReadOnly(boolean newReadOnly) {
        ...
        readOnlyESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.VENDOR_NAME_TYPE__READ_ONLY, oldReadOnly,
    ...
    public void unsetReadOnly() {
        ...
        readOnlyESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.VENDOR_NAME_TYPE__READ_ONLY, oldReadOnly,
