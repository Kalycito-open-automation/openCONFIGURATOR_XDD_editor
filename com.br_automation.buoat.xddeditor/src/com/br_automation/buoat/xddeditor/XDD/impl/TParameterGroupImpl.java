 ...
 * </p>
 * <ul>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TParameterGroupImpl#getGroup
 * <em>Group</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TParameterGroupImpl#getLabel
 * <em>Label</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TParameterGroupImpl#getDescription
 * <em>Description</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TParameterGroupImpl#getLabelRef
 * <em>Label Ref</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TParameterGroupImpl#getDescriptionRef
 * <em>Description Ref</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TParameterGroupImpl#getGroup1
 * <em>Group1</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TParameterGroupImpl#getParameterGroup
 * <em>Parameter Group</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TParameterGroupImpl#getParameterRef
 * <em>Parameter Ref</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TParameterGroupImpl#getBitOffset
 * <em>Bit Offset</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TParameterGroupImpl#getConditionalUniqueIDRef
 * <em>Conditional Unique ID Ref</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TParameterGroupImpl#getConditionalValue
 * <em>Conditional Value</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TParameterGroupImpl#isConfigParameter
 * <em>Config Parameter</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TParameterGroupImpl#isGroupLevelVisible
 * <em>Group Level Visible</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TParameterGroupImpl#getKindOfAccess
 * <em>Kind Of Access</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TParameterGroupImpl#getUniqueID
 * <em>Unique ID</em>}</li>
 * </ul>
 *
 * @generated
...
public class TParameterGroupImpl extends EObjectImpl implements TParameterGroup {
    ...
    /**
     * The default value of the '{@link #getConditionalUniqueIDRef()
     * <em>Conditional Unique ID Ref</em>}' attribute. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getConditionalUniqueIDRef()
     * <em>Conditional Unique ID Ref</em>}' attribute. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see #getConditionalUniqueIDRef()
    ...
    /**
     * The default value of the '{@link #getConditionalValue() <em>Conditional
    ...
    /**
     * The cached value of the '{@link #getConditionalValue() <em>Conditional
     * Value</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @see #getConditionalValue()
     * @generated
    ...
    /**
     * The default value of the '{@link #isConfigParameter() <em>Config
    ...
    /**
     * The cached value of the '{@link #isConfigParameter() <em>Config
     * Parameter</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @see #isConfigParameter()
     * @generated
    ...
    /**
     * The default value of the '{@link #isGroupLevelVisible() <em>Group Level
    ...
    /**
     * The cached value of the '{@link #isGroupLevelVisible() <em>Group Level
     * Visible</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @see #isGroupLevelVisible()
     * @generated
    ...
    /**
     * The default value of the '{@link #getKindOfAccess() <em>Kind Of
     * Access</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @see #getKindOfAccess()
     * @generated
     * @ordered
    ...
    /**
     * The cached value of the '{@link #getKindOfAccess() <em>Kind Of
     * Access</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @see #getKindOfAccess()
     * @generated
    ...
    public void setBitOffset(BigInteger newBitOffset) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TPARAMETER_GROUP__BIT_OFFSET, oldBitOffset,
                    bitOffset, !oldBitOffsetESet));
    }
    ...
    public void unsetBitOffset() {
        ...
        bitOffsetESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.TPARAMETER_GROUP__BIT_OFFSET,
                    oldBitOffset, BIT_OFFSET_EDEFAULT, oldBitOffsetESet));
    }
    ...
    public void setConditionalUniqueIDRef(String newConditionalUniqueIDRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    XDDPackage.TPARAMETER_GROUP__CONDITIONAL_UNIQUE_ID_REF, oldConditionalUniqueIDRef,
    ...
    public void setConditionalValue(String newConditionalValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TPARAMETER_GROUP__CONDITIONAL_VALUE,
                    oldConditionalValue, conditionalValue));
    }
    ...
    public void setConfigParameter(boolean newConfigParameter) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TPARAMETER_GROUP__CONFIG_PARAMETER,
                    oldConfigParameter, configParameter, !oldConfigParameterESet));
    }
    ...
    public void unsetConfigParameter() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.TPARAMETER_GROUP__CONFIG_PARAMETER,
                    oldConfigParameter, CONFIG_PARAMETER_EDEFAULT, oldConfigParameterESet));
    }
    ...
    public void setGroupLevelVisible(boolean newGroupLevelVisible) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TPARAMETER_GROUP__GROUP_LEVEL_VISIBLE,
                    oldGroupLevelVisible, groupLevelVisible, !oldGroupLevelVisibleESet));
    }
    ...
    public void unsetGroupLevelVisible() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.TPARAMETER_GROUP__GROUP_LEVEL_VISIBLE,
                    oldGroupLevelVisible, GROUP_LEVEL_VISIBLE_EDEFAULT, oldGroupLevelVisibleESet));
    }
    ...
    public void setKindOfAccess(String newKindOfAccess) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TPARAMETER_GROUP__KIND_OF_ACCESS,
                    oldKindOfAccess, kindOfAccess));
    }
    ...
    public void setUniqueID(String newUniqueID) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TPARAMETER_GROUP__UNIQUE_ID, oldUniqueID,
                    uniqueID));
    }
    ...
    public boolean eIsSet(int featureID) {
        ...
        case XDDPackage.TPARAMETER_GROUP__CONDITIONAL_UNIQUE_ID_REF:
            return CONDITIONAL_UNIQUE_ID_REF_EDEFAULT == null ? conditionalUniqueIDRef != null
                    : !CONDITIONAL_UNIQUE_ID_REF_EDEFAULT.equals(conditionalUniqueIDRef);
        case XDDPackage.TPARAMETER_GROUP__CONDITIONAL_VALUE:
            return CONDITIONAL_VALUE_EDEFAULT == null ? conditionalValue != null
                    : !CONDITIONAL_VALUE_EDEFAULT.equals(conditionalValue);
        case XDDPackage.TPARAMETER_GROUP__CONFIG_PARAMETER:
    ...
    public String toString() {
        ...
        if (configParameterESet)
            result.append(configParameter);
        else
            result.append("<unset>");
        result.append(", groupLevelVisible: ");
        if (groupLevelVisibleESet)
            result.append(groupLevelVisible);
        else
            result.append("<unset>");
