 ...
 * </p>
 * <ul>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TDeviceManagerImpl#getIndicatorList
...
public class TDeviceManagerImpl extends EObjectImpl implements TDeviceManager {
    /**
     * The cached value of the '{@link #getIndicatorList() <em>Indicator
    ...
    public void setIndicatorList(TIndicatorList newIndicatorList) {
        if (newIndicatorList != indicatorList) {
            ...
            if (indicatorList != null)
                msgs = ((InternalEObject) indicatorList).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - XDDPackage.TDEVICE_MANAGER__INDICATOR_LIST, null, msgs);
            if (newIndicatorList != null)
                msgs = ((InternalEObject) newIndicatorList).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - XDDPackage.TDEVICE_MANAGER__INDICATOR_LIST, null, msgs);
            msgs = basicSetIndicatorList(newIndicatorList, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TDEVICE_MANAGER__INDICATOR_LIST,
                    newIndicatorList, newIndicatorList));
    }
