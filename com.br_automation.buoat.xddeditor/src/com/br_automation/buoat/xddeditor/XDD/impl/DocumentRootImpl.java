 ...
 * </p>
 * <ul>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.DocumentRootImpl#getMixed
 * <em>Mixed</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.DocumentRootImpl#getXMLNSPrefixMap
 * <em>XMLNS Prefix Map</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.DocumentRootImpl#getXSISchemaLocation
 * <em>XSI Schema Location</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.DocumentRootImpl#getClassification
 * <em>Classification</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.DocumentRootImpl#getConnector
 * <em>Connector</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.DocumentRootImpl#getFirmware
 * <em>Firmware</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.DocumentRootImpl#getISO15745Profile
 * <em>ISO15745 Profile</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.DocumentRootImpl#getISO15745ProfileContainer
 * <em>ISO15745 Profile Container</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.DocumentRootImpl#getTextResource
...
public class DocumentRootImpl extends EObjectImpl implements DocumentRoot {
    ...
    public EMap<String, String> getXSISchemaLocation() {
        if (xSISchemaLocation == null) {
            xSISchemaLocation = new EcoreEMap<String, String>(EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY,
                    EStringToStringMapEntryImpl.class, this, XDDPackage.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION);
        }
    ...
    public void setClassification(ClassificationType newClassification) {
        ((FeatureMap.Internal) getMixed()).set(XDDPackage.eINSTANCE.getDocumentRoot_Classification(),
                newClassification);
    }
    ...
    public NotificationChain basicSetConnector(ConnectorType newConnector, NotificationChain msgs) {
        return ((FeatureMap.Internal) getMixed()).basicAdd(XDDPackage.eINSTANCE.getDocumentRoot_Connector(),
                newConnector, msgs);
    }
    ...
    public NotificationChain basicSetFirmware(FirmwareType newFirmware, NotificationChain msgs) {
        return ((FeatureMap.Internal) getMixed()).basicAdd(XDDPackage.eINSTANCE.getDocumentRoot_Firmware(), newFirmware,
                msgs);
    }
    ...
    public NotificationChain basicSetISO15745Profile(ISO15745ProfileType newISO15745Profile, NotificationChain msgs) {
        return ((FeatureMap.Internal) getMixed()).basicAdd(XDDPackage.eINSTANCE.getDocumentRoot_ISO15745Profile(),
                newISO15745Profile, msgs);
    }
    ...
    public void setISO15745Profile(ISO15745ProfileType newISO15745Profile) {
        ((FeatureMap.Internal) getMixed()).set(XDDPackage.eINSTANCE.getDocumentRoot_ISO15745Profile(),
                newISO15745Profile);
    }
    ...
    public ISO15745ProfileContainerType getISO15745ProfileContainer() {
        return (ISO15745ProfileContainerType) getMixed()
                .get(XDDPackage.eINSTANCE.getDocumentRoot_ISO15745ProfileContainer(), true);
    }
     ...
     * @generated
     */
    public NotificationChain basicSetISO15745ProfileContainer(ISO15745ProfileContainerType newISO15745ProfileContainer,
            NotificationChain msgs) {
        return ((FeatureMap.Internal) getMixed()).basicAdd(
                XDDPackage.eINSTANCE.getDocumentRoot_ISO15745ProfileContainer(), newISO15745ProfileContainer, msgs);
    }
    ...
    public void setISO15745ProfileContainer(ISO15745ProfileContainerType newISO15745ProfileContainer) {
        ((FeatureMap.Internal) getMixed()).set(XDDPackage.eINSTANCE.getDocumentRoot_ISO15745ProfileContainer(),
    ...
    public NotificationChain basicSetTextResource(TextResourceType newTextResource, NotificationChain msgs) {
        return ((FeatureMap.Internal) getMixed()).basicAdd(XDDPackage.eINSTANCE.getDocumentRoot_TextResource(),
                newTextResource, msgs);
    }
