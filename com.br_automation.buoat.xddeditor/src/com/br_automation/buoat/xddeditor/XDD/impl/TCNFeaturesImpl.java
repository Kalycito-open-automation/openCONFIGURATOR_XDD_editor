...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>TCN
 * Features</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TCNFeaturesImpl#isDLLCNFeatureMultiplex
 * <em>DLLCN Feature Multiplex</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TCNFeaturesImpl#isDLLCNPResChaining
 * <em>DLLCNP Res Chaining</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TCNFeaturesImpl#isNMTCNDNA
 * <em>NMTCNDNA</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TCNFeaturesImpl#getNMTCNMaxAInv
 * <em>NMTCN Max AInv</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TCNFeaturesImpl#getNMTCNPreOp2ToReady2Op
 * <em>NMTCN Pre Op2 To Ready2 Op</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TCNFeaturesImpl#getNMTCNSetNodeNumberTime
 * <em>NMTCN Set Node Number Time</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TCNFeaturesImpl#getNMTCNSoC2PReq
...
public class TCNFeaturesImpl extends EObjectImpl implements TCNFeatures {
    /**
     * The default value of the '{@link #isDLLCNFeatureMultiplex() <em>DLLCN
    ...
    /**
     * The cached value of the '{@link #isDLLCNFeatureMultiplex() <em>DLLCN
     * Feature Multiplex</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @see #isDLLCNFeatureMultiplex()
    ...
    /**
     * The default value of the '{@link #isDLLCNPResChaining() <em>DLLCNP Res
    ...
    /**
     * The cached value of the '{@link #isDLLCNPResChaining() <em>DLLCNP Res
     * Chaining</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @see #isDLLCNPResChaining()
     * @generated
    ...
    /**
     * The default value of the '{@link #isNMTCNDNA() <em>NMTCNDNA</em>}'
    ...
    /**
     * The cached value of the '{@link #isNMTCNDNA() <em>NMTCNDNA</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @see #isNMTCNDNA()
     * @generated
    ...
    /**
     * This is true if the NMTCNDNA attribute has been set. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     *
     * @generated
     * @ordered
    ...
    /**
     * The default value of the '{@link #getNMTCNMaxAInv() <em>NMTCN Max
     * AInv</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @see #getNMTCNMaxAInv()
     * @generated
     * @ordered
    ...
    /**
     * The cached value of the '{@link #getNMTCNMaxAInv() <em>NMTCN Max
     * AInv</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @see #getNMTCNMaxAInv()
     * @generated
    ...
    /**
     * The default value of the '{@link #getNMTCNPreOp2ToReady2Op() <em>NMTCN
     * Pre Op2 To Ready2 Op</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getNMTCNPreOp2ToReady2Op() <em>NMTCN Pre
     * Op2 To Ready2 Op</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @see #getNMTCNPreOp2ToReady2Op()
     * @generated
    ...
    /**
     * The default value of the '{@link #getNMTCNSetNodeNumberTime() <em>NMTCN
     * Set Node Number Time</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getNMTCNSetNodeNumberTime() <em>NMTCN
     * Set Node Number Time</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @see #getNMTCNSetNodeNumberTime()
    ...
    /**
     * The default value of the '{@link #getNMTCNSoC2PReq() <em>NMTCN So C2P
    ...
    /**
     * The cached value of the '{@link #getNMTCNSoC2PReq() <em>NMTCN So C2P
     * Req</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @see #getNMTCNSoC2PReq()
     * @generated
    ...
    public void setDLLCNFeatureMultiplex(boolean newDLLCNFeatureMultiplex) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TCN_FEATURES__DLLCN_FEATURE_MULTIPLEX,
                    oldDLLCNFeatureMultiplex, dLLCNFeatureMultiplex, !oldDLLCNFeatureMultiplexESet));
    }
    ...
    public void unsetDLLCNFeatureMultiplex() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.TCN_FEATURES__DLLCN_FEATURE_MULTIPLEX,
                    oldDLLCNFeatureMultiplex, DLLCN_FEATURE_MULTIPLEX_EDEFAULT, oldDLLCNFeatureMultiplexESet));
    }
    ...
    public void setDLLCNPResChaining(boolean newDLLCNPResChaining) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TCN_FEATURES__DLLCNP_RES_CHAINING,
                    oldDLLCNPResChaining, dLLCNPResChaining, !oldDLLCNPResChainingESet));
    }
    ...
    public void unsetDLLCNPResChaining() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.TCN_FEATURES__DLLCNP_RES_CHAINING,
                    oldDLLCNPResChaining, DLLCNP_RES_CHAINING_EDEFAULT, oldDLLCNPResChainingESet));
    }
    ...
    public void setNMTCNDNA(boolean newNMTCNDNA) {
        ...
        nMTCNDNAESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TCN_FEATURES__NMTCNDNA, oldNMTCNDNA,
                    nMTCNDNA, !oldNMTCNDNAESet));
    }
    ...
    public void unsetNMTCNDNA() {
        ...
        nMTCNDNAESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.TCN_FEATURES__NMTCNDNA, oldNMTCNDNA,
                    NMTCNDNA_EDEFAULT, oldNMTCNDNAESet));
    }
    ...
    public void setNMTCNMaxAInv(long newNMTCNMaxAInv) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TCN_FEATURES__NMTCN_MAX_AINV,
                    oldNMTCNMaxAInv, nMTCNMaxAInv, !oldNMTCNMaxAInvESet));
    }
    ...
    public void unsetNMTCNMaxAInv() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.TCN_FEATURES__NMTCN_MAX_AINV,
                    oldNMTCNMaxAInv, NMTCN_MAX_AINV_EDEFAULT, oldNMTCNMaxAInvESet));
    }
    ...
    public void setNMTCNPreOp2ToReady2Op(long newNMTCNPreOp2ToReady2Op) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TCN_FEATURES__NMTCN_PRE_OP2_TO_READY2_OP,
                    oldNMTCNPreOp2ToReady2Op, nMTCNPreOp2ToReady2Op, !oldNMTCNPreOp2ToReady2OpESet));
    }
    ...
    public void unsetNMTCNPreOp2ToReady2Op() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.TCN_FEATURES__NMTCN_PRE_OP2_TO_READY2_OP,
                    oldNMTCNPreOp2ToReady2Op, NMTCN_PRE_OP2_TO_READY2_OP_EDEFAULT, oldNMTCNPreOp2ToReady2OpESet));
    }
    ...
    public void setNMTCNSetNodeNumberTime(long newNMTCNSetNodeNumberTime) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TCN_FEATURES__NMTCN_SET_NODE_NUMBER_TIME,
                    oldNMTCNSetNodeNumberTime, nMTCNSetNodeNumberTime, !oldNMTCNSetNodeNumberTimeESet));
    }
    ...
    public void unsetNMTCNSetNodeNumberTime() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.TCN_FEATURES__NMTCN_SET_NODE_NUMBER_TIME,
                    oldNMTCNSetNodeNumberTime, NMTCN_SET_NODE_NUMBER_TIME_EDEFAULT, oldNMTCNSetNodeNumberTimeESet));
    }
    ...
    public void setNMTCNSoC2PReq(long newNMTCNSoC2PReq) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TCN_FEATURES__NMTCN_SO_C2P_REQ,
                    oldNMTCNSoC2PReq, nMTCNSoC2PReq, !oldNMTCNSoC2PReqESet));
    }
    ...
    public void unsetNMTCNSoC2PReq() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.TCN_FEATURES__NMTCN_SO_C2P_REQ,
                    oldNMTCNSoC2PReq, NMTCN_SO_C2P_REQ_EDEFAULT, oldNMTCNSoC2PReqESet));
    }
    ...
    public String toString() {
        ...
        if (nMTCNPreOp2ToReady2OpESet)
            result.append(nMTCNPreOp2ToReady2Op);
        else
            result.append("<unset>");
        result.append(", nMTCNSetNodeNumberTime: ");
        if (nMTCNSetNodeNumberTimeESet)
            result.append(nMTCNSetNodeNumberTime);
        else
            result.append("<unset>");
