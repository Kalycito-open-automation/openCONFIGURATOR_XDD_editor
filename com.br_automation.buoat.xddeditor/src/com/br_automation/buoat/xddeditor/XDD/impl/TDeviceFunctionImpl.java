 ...
 * </p>
 * <ul>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TDeviceFunctionImpl#getCapabilities
 * <em>Capabilities</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TDeviceFunctionImpl#getPicturesList
 * <em>Pictures List</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TDeviceFunctionImpl#getDictionaryList
 * <em>Dictionary List</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TDeviceFunctionImpl#getConnectorList
 * <em>Connector List</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TDeviceFunctionImpl#getFirmwareList
 * <em>Firmware List</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TDeviceFunctionImpl#getClassificationList
 * <em>Classification List</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TDeviceFunctionImpl extends EObjectImpl implements TDeviceFunction {
    /**
     * The cached value of the '{@link #getCapabilities()
    ...
    /**
     * The cached value of the '{@link #getPicturesList() <em>Pictures
    ...
    /**
     * The cached value of the '{@link #getDictionaryList() <em>Dictionary
     * List</em>}' containment reference. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getConnectorList() <em>Connector
     * List</em>}' containment reference. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getFirmwareList() <em>Firmware
     * List</em>}' containment reference. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @see #getFirmwareList()
    ...
    /**
     * The cached value of the '{@link #getClassificationList()
     * <em>Classification List</em>}' containment reference. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     *
    ...
    public void setCapabilities(TCapabilities newCapabilities) {
        if (newCapabilities != capabilities) {
            ...
            if (capabilities != null)
                msgs = ((InternalEObject) capabilities).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - XDDPackage.TDEVICE_FUNCTION__CAPABILITIES, null, msgs);
            if (newCapabilities != null)
                msgs = ((InternalEObject) newCapabilities).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - XDDPackage.TDEVICE_FUNCTION__CAPABILITIES, null, msgs);
            msgs = basicSetCapabilities(newCapabilities, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TDEVICE_FUNCTION__CAPABILITIES,
    ...
    public void setPicturesList(TPicturesList newPicturesList) {
        if (newPicturesList != picturesList) {
            ...
            if (picturesList != null)
                msgs = ((InternalEObject) picturesList).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - XDDPackage.TDEVICE_FUNCTION__PICTURES_LIST, null, msgs);
            if (newPicturesList != null)
                msgs = ((InternalEObject) newPicturesList).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - XDDPackage.TDEVICE_FUNCTION__PICTURES_LIST, null, msgs);
            msgs = basicSetPicturesList(newPicturesList, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TDEVICE_FUNCTION__PICTURES_LIST,
                    newPicturesList, newPicturesList));
    }
    ...
    public void setDictionaryList(TDictionaryList newDictionaryList) {
        if (newDictionaryList != dictionaryList) {
            ...
            if (dictionaryList != null)
                msgs = ((InternalEObject) dictionaryList).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - XDDPackage.TDEVICE_FUNCTION__DICTIONARY_LIST, null, msgs);
            if (newDictionaryList != null)
                msgs = ((InternalEObject) newDictionaryList).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - XDDPackage.TDEVICE_FUNCTION__DICTIONARY_LIST, null, msgs);
            msgs = basicSetDictionaryList(newDictionaryList, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TDEVICE_FUNCTION__DICTIONARY_LIST,
                    newDictionaryList, newDictionaryList));
    }
    ...
    public NotificationChain basicSetConnectorList(TConnectorList newConnectorList, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    XDDPackage.TDEVICE_FUNCTION__CONNECTOR_LIST, oldConnectorList, newConnectorList);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setConnectorList(TConnectorList newConnectorList) {
        if (newConnectorList != connectorList) {
            ...
            if (connectorList != null)
                msgs = ((InternalEObject) connectorList).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - XDDPackage.TDEVICE_FUNCTION__CONNECTOR_LIST, null, msgs);
            if (newConnectorList != null)
                msgs = ((InternalEObject) newConnectorList).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - XDDPackage.TDEVICE_FUNCTION__CONNECTOR_LIST, null, msgs);
            msgs = basicSetConnectorList(newConnectorList, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TDEVICE_FUNCTION__CONNECTOR_LIST,
                    newConnectorList, newConnectorList));
    }
    ...
    public NotificationChain basicSetFirmwareList(TFirmwareList newFirmwareList, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    XDDPackage.TDEVICE_FUNCTION__FIRMWARE_LIST, oldFirmwareList, newFirmwareList);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setFirmwareList(TFirmwareList newFirmwareList) {
        if (newFirmwareList != firmwareList) {
            ...
            if (firmwareList != null)
                msgs = ((InternalEObject) firmwareList).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - XDDPackage.TDEVICE_FUNCTION__FIRMWARE_LIST, null, msgs);
            if (newFirmwareList != null)
                msgs = ((InternalEObject) newFirmwareList).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - XDDPackage.TDEVICE_FUNCTION__FIRMWARE_LIST, null, msgs);
            msgs = basicSetFirmwareList(newFirmwareList, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TDEVICE_FUNCTION__FIRMWARE_LIST,
                    newFirmwareList, newFirmwareList));
    }
     ...
     * @generated
     */
    public NotificationChain basicSetClassificationList(TClassificationList newClassificationList,
            NotificationChain msgs) {
        TClassificationList oldClassificationList = classificationList;
        classificationList = newClassificationList;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    XDDPackage.TDEVICE_FUNCTION__CLASSIFICATION_LIST, oldClassificationList, newClassificationList);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setClassificationList(TClassificationList newClassificationList) {
        if (newClassificationList != classificationList) {
            ...
            if (classificationList != null)
                msgs = ((InternalEObject) classificationList).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - XDDPackage.TDEVICE_FUNCTION__CLASSIFICATION_LIST, null, msgs);
            if (newClassificationList != null)
                msgs = ((InternalEObject) newClassificationList).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - XDDPackage.TDEVICE_FUNCTION__CLASSIFICATION_LIST, null, msgs);
            msgs = basicSetClassificationList(newClassificationList, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TDEVICE_FUNCTION__CLASSIFICATION_LIST,
                    newClassificationList, newClassificationList));
    }
