 ...
 * </p>
 * <ul>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TParameterGroupListImpl#getParameterGroup
...
public class TParameterGroupListImpl extends EObjectImpl implements TParameterGroupList {
    /**
     * The cached value of the '{@link #getParameterGroup() <em>Parameter
     * Group</em>}' containment reference list. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    public EList<TParameterGroup> getParameterGroup() {
        if (parameterGroup == null) {
            parameterGroup = new EObjectContainmentEList<TParameterGroup>(TParameterGroup.class, this,
                    XDDPackage.TPARAMETER_GROUP_LIST__PARAMETER_GROUP);
        }
