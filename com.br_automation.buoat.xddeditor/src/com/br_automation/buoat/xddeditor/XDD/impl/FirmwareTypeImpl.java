 ...
 * '<em><b>Firmware Type</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.FirmwareTypeImpl#getGroup
 * <em>Group</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.FirmwareTypeImpl#getLabel
 * <em>Label</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.FirmwareTypeImpl#getDescription
 * <em>Description</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.FirmwareTypeImpl#getLabelRef
 * <em>Label Ref</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.FirmwareTypeImpl#getDescriptionRef
 * <em>Description Ref</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.FirmwareTypeImpl#getBuildDate
 * <em>Build Date</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.FirmwareTypeImpl#getDeviceRevisionNumber
 * <em>Device Revision Number</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.FirmwareTypeImpl#getURI
 * <em>URI</em>}</li>
 * </ul>
 *
 * @generated
...
public class FirmwareTypeImpl extends EObjectImpl implements FirmwareType {
    ...
    /**
     * The default value of the '{@link #getDeviceRevisionNumber() <em>Device
     * Revision Number</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getDeviceRevisionNumber() <em>Device
     * Revision Number</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @see #getDeviceRevisionNumber()
    ...
    public void setBuildDate(XMLGregorianCalendar newBuildDate) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.FIRMWARE_TYPE__BUILD_DATE, oldBuildDate,
                    buildDate));
    }
    ...
    public void setDeviceRevisionNumber(BigInteger newDeviceRevisionNumber) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.FIRMWARE_TYPE__DEVICE_REVISION_NUMBER,
                    oldDeviceRevisionNumber, deviceRevisionNumber));
    }
    ...
    public boolean eIsSet(int featureID) {
        ...
        case XDDPackage.FIRMWARE_TYPE__DEVICE_REVISION_NUMBER:
            return DEVICE_REVISION_NUMBER_EDEFAULT == null ? deviceRevisionNumber != null
                    : !DEVICE_REVISION_NUMBER_EDEFAULT.equals(deviceRevisionNumber);
        case XDDPackage.FIRMWARE_TYPE__URI:
