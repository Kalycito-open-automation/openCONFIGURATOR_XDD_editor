 ...
 * Name Type</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ProductNameTypeImpl#getValue
 * <em>Value</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ProductNameTypeImpl#isReadOnly
 * <em>Read Only</em>}</li>
 * </ul>
 *
 * @generated
...
public class ProductNameTypeImpl extends EObjectImpl implements ProductNameType {
    ...
    public void setValue(String newValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.PRODUCT_NAME_TYPE__VALUE, oldValue,
                    value));
    }
    ...
    public void setReadOnly(boolean newReadOnly) {
        ...
        readOnlyESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.PRODUCT_NAME_TYPE__READ_ONLY, oldReadOnly,
    ...
    public void unsetReadOnly() {
        ...
        readOnlyESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.PRODUCT_NAME_TYPE__READ_ONLY,
