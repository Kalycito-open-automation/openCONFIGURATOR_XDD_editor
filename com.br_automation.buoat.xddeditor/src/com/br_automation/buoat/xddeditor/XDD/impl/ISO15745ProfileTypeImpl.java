 ...
 * </p>
 * <ul>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ISO15745ProfileTypeImpl#getProfileHeader
 * <em>Profile Header</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ISO15745ProfileTypeImpl#getProfileBody
...
public class ISO15745ProfileTypeImpl extends EObjectImpl implements ISO15745ProfileType {
    /**
     * The cached value of the '{@link #getProfileHeader() <em>Profile
     * Header</em>}' containment reference. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    public NotificationChain basicSetProfileHeader(ProfileHeaderDataType newProfileHeader, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    XDDPackage.ISO15745_PROFILE_TYPE__PROFILE_HEADER, oldProfileHeader, newProfileHeader);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setProfileHeader(ProfileHeaderDataType newProfileHeader) {
        if (newProfileHeader != profileHeader) {
            ...
            if (profileHeader != null)
                msgs = ((InternalEObject) profileHeader).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - XDDPackage.ISO15745_PROFILE_TYPE__PROFILE_HEADER, null, msgs);
            if (newProfileHeader != null)
                msgs = ((InternalEObject) newProfileHeader).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - XDDPackage.ISO15745_PROFILE_TYPE__PROFILE_HEADER, null, msgs);
            msgs = basicSetProfileHeader(newProfileHeader, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.ISO15745_PROFILE_TYPE__PROFILE_HEADER,
    ...
    public void setProfileBody(ProfileBodyDataType newProfileBody) {
        if (newProfileBody != profileBody) {
            NotificationChain msgs = null;
            if (profileBody != null)
                msgs = ((InternalEObject) profileBody).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - XDDPackage.ISO15745_PROFILE_TYPE__PROFILE_BODY, null, msgs);
            if (newProfileBody != null)
                msgs = ((InternalEObject) newProfileBody).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - XDDPackage.ISO15745_PROFILE_TYPE__PROFILE_BODY, null, msgs);
            msgs = basicSetProfileBody(newProfileBody, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.ISO15745_PROFILE_TYPE__PROFILE_BODY,
