...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>TCN
 ...
 * </p>
 * <ul>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.TCNFeatures#isDLLCNFeatureMultiplex
 * <em>DLLCN Feature Multiplex</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.TCNFeatures#isDLLCNPResChaining
 * <em>DLLCNP Res Chaining</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.TCNFeatures#isNMTCNDNA
 * <em>NMTCNDNA</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.TCNFeatures#getNMTCNMaxAInv
 * <em>NMTCN Max AInv</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.TCNFeatures#getNMTCNPreOp2ToReady2Op
 * <em>NMTCN Pre Op2 To Ready2 Op</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.TCNFeatures#getNMTCNSetNodeNumberTime
 * <em>NMTCN Set Node Number Time</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.TCNFeatures#getNMTCNSoC2PReq
...
public interface TCNFeatures extends EObject {
    ...
    /**
     * Returns the value of the '<em><b>NMTCNDNA</b></em>' attribute. The
     * default value is <code>"false"</code>. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>NMTCNDNA</em>' attribute isn't clear, there
     ...
     * <em>NMTCNDNA</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
     * @param value
     *            the new value of the '<em>NMTCNDNA</em>' attribute.
     * @see #isSetNMTCNDNA()
     * @see #unsetNMTCNDNA()
     * @see #isNMTCNDNA()
     * @generated
     ...
     * Returns whether the value of the
     * '{@link com.br_automation.buoat.xddeditor.XDD.TCNFeatures#isNMTCNDNA
     * <em>NMTCNDNA</em>}' attribute is set. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>NMTCN Max AInv</b></em>' attribute. The
     ...
     * <em>NMTCN Max AInv</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>NMTCN Max AInv</em>' attribute.
     * @see #isSetNMTCNMaxAInv()
     * @see #unsetNMTCNMaxAInv()
     * @see #getNMTCNMaxAInv()
     * @generated
     ...
     * Returns whether the value of the
     * '{@link com.br_automation.buoat.xddeditor.XDD.TCNFeatures#getNMTCNMaxAInv
     * <em>NMTCN Max AInv</em>}' attribute is set. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @return whether the value of the '<em>NMTCN Max AInv</em>' attribute is
     *         set.
     * @see #unsetNMTCNMaxAInv()
     * @see #getNMTCNMaxAInv()
     * @see #setNMTCNMaxAInv(long)
    ...
    /**
     * Returns the value of the '<em><b>NMTCN Pre Op2 To Ready2 Op</b></em>'
     * attribute. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>NMTCN Pre Op2 To Ready2 Op</em>' attribute
     ...
     * <em>NMTCN Pre Op2 To Ready2 Op</em>}' attribute. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>NMTCN Pre Op2 To Ready2 Op</em>'
     *            attribute.
     * @see #isSetNMTCNPreOp2ToReady2Op()
     * @see #unsetNMTCNPreOp2ToReady2Op()
     ...
     * Returns whether the value of the
     * '{@link com.br_automation.buoat.xddeditor.XDD.TCNFeatures#getNMTCNPreOp2ToReady2Op
     * <em>NMTCN Pre Op2 To Ready2 Op</em>}' attribute is set. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     *
     * @return whether the value of the '<em>NMTCN Pre Op2 To Ready2 Op</em>'
     *         attribute is set.
     * @see #unsetNMTCNPreOp2ToReady2Op()
     * @see #getNMTCNPreOp2ToReady2Op()
     * @see #setNMTCNPreOp2ToReady2Op(long)
    ...
    /**
     * Returns the value of the '<em><b>NMTCN Set Node Number Time</b></em>'
     * attribute. The default value is <code>"0"</code>. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>NMTCN Set Node Number Time</em>' attribute
     * isn't clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     *
     ...
     * <em>NMTCN Set Node Number Time</em>}' attribute. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>NMTCN Set Node Number Time</em>'
     *            attribute.
     * @see #isSetNMTCNSetNodeNumberTime()
     * @see #unsetNMTCNSetNodeNumberTime()
     ...
     * Returns whether the value of the
     * '{@link com.br_automation.buoat.xddeditor.XDD.TCNFeatures#getNMTCNSetNodeNumberTime
     * <em>NMTCN Set Node Number Time</em>}' attribute is set. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     *
     * @return whether the value of the '<em>NMTCN Set Node Number Time</em>'
     *         attribute is set.
     * @see #unsetNMTCNSetNodeNumberTime()
     * @see #getNMTCNSetNodeNumberTime()
     * @see #setNMTCNSetNodeNumberTime(long)
