 ...
 * </p>
 * <ul>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.DocumentRoot#getMixed
 * <em>Mixed</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.DocumentRoot#getXMLNSPrefixMap
 * <em>XMLNS Prefix Map</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.DocumentRoot#getXSISchemaLocation
 * <em>XSI Schema Location</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.DocumentRoot#getClassification
 * <em>Classification</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.DocumentRoot#getConnector
 * <em>Connector</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.DocumentRoot#getFirmware
 * <em>Firmware</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.DocumentRoot#getISO15745Profile
 * <em>ISO15745 Profile</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.DocumentRoot#getISO15745ProfileContainer
 * <em>ISO15745 Profile Container</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.DocumentRoot#getTextResource
 * <em>Text Resource</em>}</li>
 * </ul>
 *
...
public interface DocumentRoot extends EObject {
    ...
    /**
     * Returns the value of the '<em><b>Classification</b></em>' attribute. The
     ...
     *        name='classification' namespace='##targetNamespace'"
     * @generated
     */
     ...
     *
     * @param value
     *            the new value of the '<em>Classification</em>' attribute.
     * @see com.br_automation.buoat.xddeditor.XDD.ClassificationType
     ...
     * <p>
     * If the meaning of the '<em>Connector</em>' containment reference isn't
     ...
     *        derived="true" extendedMetaData="kind='element' name='connector'
     ...
     * <em>Connector</em>}' containment reference. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Connector</em>' containment
     *            reference.
     * @see #getConnector()
     * @generated
     */
    ...
    /**
     * Returns the value of the '<em><b>Firmware</b></em>' containment
     * reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Firmware</em>' containment reference isn't
     * clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     *
     ...
     * @model containment="true" upper="-2" transient="true" volatile="true"
     *        derived="true" extendedMetaData="kind='element' name='firmware'
     *        namespace='##targetNamespace'"
     * @generated
     */
     ...
     * <em>Firmware</em>}' containment reference. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Firmware</em>' containment
     *            reference.
     * @see #getFirmware()
     * @generated
     */
     ...
     * @model containment="true" upper="-2" transient="true" volatile="true"
     *        derived="true" extendedMetaData="kind='element'
     *        name='ISO15745Profile' namespace='##targetNamespace'"
     * @generated
     */
     ...
     * <em>ISO15745 Profile</em>}' containment reference. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>ISO15745 Profile</em>' containment
     *            reference.
     ...
     * @model containment="true" upper="-2" transient="true" volatile="true"
     *        derived="true" extendedMetaData="kind='element'
     *        name='ISO15745ProfileContainer' namespace='##targetNamespace'"
     * @generated
     */
    ...
    /**
     * Returns the value of the '<em><b>Text Resource</b></em>' containment
     ...
     * @model containment="true" upper="-2" transient="true" volatile="true"
     *        derived="true" extendedMetaData="kind='element'
     *        name='textResource' namespace='##targetNamespace'"
     * @generated
     */
     ...
     * <em>Text Resource</em>}' containment reference. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Text Resource</em>' containment
     *            reference.
     * @see #getTextResource()
     * @generated
     */
