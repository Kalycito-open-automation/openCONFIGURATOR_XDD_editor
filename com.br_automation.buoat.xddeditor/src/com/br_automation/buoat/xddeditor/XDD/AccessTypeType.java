 ...
 * '<em><b>Access Type Type</b></em>', and utility methods for working with
 * them. <!-- end-user-doc -->
 *
...
public enum AccessTypeType implements Enumerator {
     ...
     * @generated
     */
    private static final AccessTypeType[] VALUES_ARRAY = new AccessTypeType[] { READ_ONLY, WRITE_ONLY,
            READ_WRITE_OUTPUT, };
