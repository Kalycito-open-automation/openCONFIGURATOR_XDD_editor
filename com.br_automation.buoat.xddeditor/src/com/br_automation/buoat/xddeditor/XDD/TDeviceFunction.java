 ...
 * </p>
 * <ul>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.TDeviceFunction#getCapabilities
 * <em>Capabilities</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.TDeviceFunction#getPicturesList
 * <em>Pictures List</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.TDeviceFunction#getDictionaryList
 * <em>Dictionary List</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.TDeviceFunction#getConnectorList
 * <em>Connector List</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.TDeviceFunction#getFirmwareList
 * <em>Firmware List</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.TDeviceFunction#getClassificationList
...
public interface TDeviceFunction extends EObject {
     ...
     * @model containment="true" extendedMetaData="kind='element'
     *        name='dictionaryList' namespace='##targetNamespace'"
     * @generated
     */
    ...
    /**
     * Returns the value of the '<em><b>Connector List</b></em>' containment
     * reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Connector List</em>' containment reference
     * isn't clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     *
     ...
     * @model containment="true" extendedMetaData="kind='element'
     *        name='connectorList' namespace='##targetNamespace'"
     * @generated
     */
     ...
     * <em>Connector List</em>}' containment reference. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Connector List</em>' containment
     *            reference.
    ...
    /**
     * Returns the value of the '<em><b>Firmware List</b></em>' containment
     * reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Firmware List</em>' containment reference
     * isn't clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     *
     ...
     * @model containment="true" extendedMetaData="kind='element'
     *        name='firmwareList' namespace='##targetNamespace'"
     * @generated
     */
     ...
     * <em>Firmware List</em>}' containment reference. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Firmware List</em>' containment
     *            reference.
     * @see #getFirmwareList()
     * @generated
     */
    ...
    /**
     * Returns the value of the '<em><b>Classification List</b></em>'
     * containment reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Classification List</em>' containment
     * reference isn't clear, there really should be more of a description
     * here...
     * </p>
     * <!-- end-user-doc -->
     *
     * @return the value of the '<em>Classification List</em>' containment
     *         reference.
     ...
     * @model containment="true" extendedMetaData="kind='element'
     *        name='classificationList' namespace='##targetNamespace'"
     * @generated
     */
     ...
     *
     * @param value
     *            the new value of the '<em>Classification List</em>'
