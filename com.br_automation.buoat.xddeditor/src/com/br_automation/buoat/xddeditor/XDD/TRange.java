 ...
 * Value</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.TRange#getStep
 * <em>Step</em>}</li>
 * </ul>
 *
...
public interface TRange extends EObject {
     ...
     *        extendedMetaData="kind='element' name='minValue'
     ...
     * @model containment="true" required="true"
     *        extendedMetaData="kind='element' name='maxValue'
     *        namespace='##targetNamespace'"
     * @generated
     */
     ...
     * @model containment="true" extendedMetaData="kind='element' name='step'
     *        namespace='##targetNamespace'"
     * @generated
     */
    StepType getStep();
