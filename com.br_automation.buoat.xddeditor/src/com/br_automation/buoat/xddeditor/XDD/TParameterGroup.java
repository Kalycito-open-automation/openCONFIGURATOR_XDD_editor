 ...
 * <em>Label</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.TParameterGroup#getDescription
 * <em>Description</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.TParameterGroup#getLabelRef
 * <em>Label Ref</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.TParameterGroup#getDescriptionRef
 * <em>Description Ref</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.TParameterGroup#getGroup1
 * <em>Group1</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.TParameterGroup#getParameterGroup
 * <em>Parameter Group</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.TParameterGroup#getParameterRef
 * <em>Parameter Ref</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.TParameterGroup#getBitOffset
 * <em>Bit Offset</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.TParameterGroup#getConditionalUniqueIDRef
 * <em>Conditional Unique ID Ref</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.TParameterGroup#getConditionalValue
 * <em>Conditional Value</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.TParameterGroup#isConfigParameter
 * <em>Config Parameter</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.TParameterGroup#isGroupLevelVisible
 * <em>Group Level Visible</em>}</li>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.TParameterGroup#getKindOfAccess
...
public interface TParameterGroup extends EObject {
     ...
     * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry"
     *        many="true" extendedMetaData="kind='group' name='group:5'"
     * @generated
     */
     ...
     *        namespace='##targetNamespace' group='#group:5'"
     * @generated
     */
     ...
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData="kind='element' name='parameterRef'
     *        namespace='##targetNamespace' group='#group:5'"
     * @generated
     */
    ...
    /**
     * Returns the value of the '<em><b>Bit Offset</b></em>' attribute. The
    ...
    /**
     * Returns the value of the '<em><b>Conditional Unique ID Ref</b></em>'
     * attribute. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Conditional Unique ID Ref</em>' attribute
     * isn't clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     *
     ...
     *
     * @param value
     *            the new value of the '<em>Conditional Unique ID Ref</em>'
     *            attribute.
     ...
     * <em>Conditional Value</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Conditional Value</em>' attribute.
     ...
     * <em>Config Parameter</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Config Parameter</em>' attribute.
     * @see #isSetConfigParameter()
     * @see #unsetConfigParameter()
     ...
     * Returns whether the value of the
     * '{@link com.br_automation.buoat.xddeditor.XDD.TParameterGroup#isConfigParameter
     * <em>Config Parameter</em>}' attribute is set. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @return whether the value of the '<em>Config Parameter</em>' attribute is
     *         set.
     * @see #unsetConfigParameter()
     * @see #isConfigParameter()
     * @see #setConfigParameter(boolean)
     ...
     * The default value is <code>"false"</code>. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Group Level Visible</em>' attribute isn't
     ...
     * <em>Group Level Visible</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Group Level Visible</em>' attribute.
     * @see #isSetGroupLevelVisible()
     * @see #unsetGroupLevelVisible()
     ...
     * Returns whether the value of the
     * '{@link com.br_automation.buoat.xddeditor.XDD.TParameterGroup#isGroupLevelVisible
     * <em>Group Level Visible</em>}' attribute is set. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @return whether the value of the '<em>Group Level Visible</em>' attribute
     *         is set.
     * @see #unsetGroupLevelVisible()
     * @see #isGroupLevelVisible()
     * @see #setGroupLevelVisible(boolean)
